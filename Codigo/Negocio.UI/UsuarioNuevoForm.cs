...
namespace Negocio.UI
{
    ...
    /// de la API real de seguridad (hash PBKDF2 + validaciones de contraseña).
    /// </summary>
    public class UsuarioNuevoForm : Form
    {
        ...
        private void ConstruirInterfaz()
        {
            ...
            _lblAviso.Location = new Point(18, 234);
            _lblAviso.Size = new Size(462, 42);
